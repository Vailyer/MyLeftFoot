    ...
    <body class="signinbody">
        <div class="container text-center loginform">
            <form method="POST" action="{{ route('register') }}" class="form-signin">
                ...
                <input id="Sname" type="text" class="form-control{{ $errors->has('Sname') ? ' is-invalid' : '' }}" name="Sname" value="{{ old('Sname') }}" required autofocus>
                ...
                <input id="Pcode" type="text" class="form-control{{ $errors->has('Pcode') ? ' is-invalid' : '' }}" name="Pcode" value="{{ old('Pcode') }}" required>
                @if ($errors->has('Pcode'))
                    <span class="invalid-feedback" role="alert">
